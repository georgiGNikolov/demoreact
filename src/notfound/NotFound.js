...
const notFound = props => {
    ...
    return (
        <div id="container">
            <svg viewBox="0 0 200 82.7" style={{enableBackground: 'new 0 0 200 82.7'}} >
                <g id="Calque_1">
                ...
                <g>
                    <text transform="matrix(1.2187 0 0 1 13.0003 100.6393)" className="st3"> Page not found </text>
                </g>
                <g id="Calque_2">
                    <g>
            ...
            <div >
                <Link className="message" to="/">Take me home{/*to the paradise city where the grass is green and the girls are pretty*/}</Link> 
            </div>
        </div>
    );
}
